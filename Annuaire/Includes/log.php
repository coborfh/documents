<div class="container pat">
    ...
    ">
                ...
                <!-- </div> -->
                <div class="form-group">
                    <input type="password" class="form-control input-md" placeholder="Password" required />
                </div>
                <label class="checkbox" style="color: black">
                    <input type="checkbox" value="remember-me" />
                    Se souvenir de moi
                </label>
                <button class="btn btn-lg btn-block purple-bg" type="submit" style=" background-color: #6E329D;
    color: #fff;">
                    Valider</button>
                </form>
